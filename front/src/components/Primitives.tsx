...
// Interface unificada para facilitar a manutenção
interface InputFieldProps {
    ...
    editable?: boolean; // Adicionado aqui
...
export const InputField = forwardRef<TextInput, InputFieldProps>(
    function InputField({ label, editable = true, ...rest }, ref) {
        return (
            <View style={styles.container}>
                ...
                <TextInput
                    ...
                    style={[
                        styles.input,
                        !editable && styles.inputDisabled // Estilo visual para campo bloqueado
                    ]}
...
const styles = StyleSheet.create({
    ...
    inputDisabled: {
        backgroundColor: '#F5F5F5', // Cor de fundo cinza para indicar bloqueio
        color: colors.textMuted,
        borderColor: '#E0E0E0',
    },
    container: {

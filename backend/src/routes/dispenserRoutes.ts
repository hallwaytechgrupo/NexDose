...
import { getDispensers, claimDispenser, unclaimDispenser, releaseMedication } from '../controllers/dispenserController';
...
router.post('/:id/release', authMiddleware, releaseMedication);
